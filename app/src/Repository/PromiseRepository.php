...
/**
 * @extends ServiceEntityRepository<Promise>
 *
...
class PromiseRepository extends ServiceEntityRepository
{
    ...
    public function save(Promise $entity, bool $flush = false): void
    {
    ...
    public function remove(Promise $entity, bool $flush = false): void
    {
